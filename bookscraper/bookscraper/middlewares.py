...
class ScrapeopsFakeUserAgents:
    ...
    def __init__(self,settings):
        ...
        self.scrapeops_endpoint = settings.get("SCRAPEOPS_FAKE_USER_AGENTS_ENDPOINT","https://headers.scrapeops.io/v1/user-agents")
        self.scrapeops_fake_user_agents_active = settings.get("SCRAPEOPS_FAKE_USER_AGENTS_ENABLED",False)
        self.scrapeops_num_results = settings.get("SCRAPEOPS_NUM_RESULTS")
        self.headers_list = []
        self._get_fake_user_agents()
        self._scrapeops_fake_user_agents_enabled()
        
    def _get_fake_user_agents(self):
    ...
    def process_request(self, request, spider):
        random_user = self._get_random_user()
...
class ScrapeopsFakeBrowserHeaders:
    ...
    def __init__(self,settings):
        self.scrapeops_api_key = settings.get("SCRAPEOPS_API_KEY")
        self.scrapeops_endpoint = settings.get("SCRAPEOPS_FAKE_BROWSER_HEADERS_ENDPOINT","https://headers.scrapeops.io/v1/browser-headers")
        self.scrapeops_browser_headers_active = settings.get("SCRAPEOPS_FAKE_BROWSER_HEADERS_ENABLED",True)
        self.scrapeops_num_results = settings.get("SCRAPEOPS_NUM_RESULTS")
        self.headers_list = []
        self._get_fake_browser_headers()
        self._scrapeops_fake_browser_headers_enabled()
        
    def _get_fake_browser_headers(self):
    ...
    def _scrapeops_fake_browser_headers_enabled(self):
        if self.scrapeops_api_key is None or self.scrapeops_api_key == " " or self.scrapeops_browser_headers_active == False:
            scrapeops_browser_headers_active = False
        else:
